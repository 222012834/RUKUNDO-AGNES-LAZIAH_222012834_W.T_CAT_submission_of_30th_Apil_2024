...
<center>
    <div class="container">
        ...
        <h4 style="text-align: center; font-family: century; font-weight: bold; color:blue;">THIS TABLE SHOWS ALL EMPLOYEES IN THIS SYSTEM </h4>
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "
                        ...
                        <td>{$row['position']}</td>
                        <td>
                            <a href='/RUKUNDO_AGNES_LAZIAH_222012834_GrpB_CAT /updateemployee.php?emp_id={$row['emp_id']}' class='btn btn-primary btn-sm'>Update</a></td>
                            <td>
                            <a href='/RUKUNDO_AGNES_LAZIAH_222012834_GrpB_CAT/deleteemployee.php?emp_id={$row['emp_id']}' class='btn btn-danger btn-sm'>Delete</a>
                        </td>
                    </tr>
                    ";
                }
